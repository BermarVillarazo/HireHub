...
export default function NotFound() {
    return (
        <section className="flex min-h-screen flex-col items-center justify-center gap-24 p-5 bg-red-900">
            <div className="flex items-center flex-col justify-center px-5 py-10 bg-white rounded-lg">
                <Image
                    src={homepageLogo}
