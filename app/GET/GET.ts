...
export async function getAllDepartments() {
  const response = await fetch(
    "http://localhost:3000/api/recruitment_staff/department",
    {
      cache: "no-cache",
    }
  );
...
export async function getAllOffices() {
  const response = await fetch(
    "http://localhost:3000/api/recruitment_staff/office",
    {
      cache: "no-cache",
    }
  );
...
export async function getAllApplicants() {
  const response = await fetch(
    "http://localhost:3000/api/recruitment_staff/applicant",
    {
      cache: "no-cache",
    }
  );
