...
const variants = {
    base: "relative rounded-md p-4 w-96 max-w-[calc(100vw-1rem)] flex justify-center items-center flex-col cursor-pointer border border-dashed border-white dark:border-gray-300 transition-colors duration-200 ease-in-out",
    active: "border-2",
    disabled:
                    ...
                    <div>
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center justify-center text-xs text-white">
                                ...
                                <div className="text-white">drag & drop or click to upload</div>
                            </div>
                        </div>
                            ...
                            <div className="flex items-center gap-2 text-gray-500 dark:text-white">
                                ...
                                <div className="flex w-12 justify-end text-xs">
                                    {progress === "PENDING" ? (
                                        ...
                                        <CheckCircleIcon className="shrink-0 text-green-600 dark:text-white" />
                                    )}
                                </div>
                            </div>
                            {/* Progress Bar */}
                            {typeof progress === "number" && (
                                <div className="relative h-0">
                                    <div className="absolute top-1 h-1 w-full overflow-clip rounded-full bg-gray-200 dark:bg-gray-700">
                                        <div
                                            className="h-full bg-white transition-all duration-300 ease-in-out dark:bg-white"
                                            style={{
